    ...
    return (
        ...
        <svg 
          ...
          <g>
            ...
            <g id="planet">
              <circle fill="none" stroke="#0E0620" strokeWidth="3" nastrokemiterlimitme="10" cx="572.859" cy="108.803"
                r="90.788" />

              <circle id="craterBig" fill="none" stroke="#0E0620" strokeWidth="3" nastrokemiterlimitme="10" cx="548.891"
                cy="62.319" r="13.074" />

              <circle id="craterSmall" fill="none" stroke="#0E0620" strokeWidth="3" nastrokemiterlimitme="10" cx="591.743"
                cy="158.918" r="7.989" />
              <path id="ring" fill="none" stroke="#0E0620" strokeWidth="3" strokeLinecap="round"
                nastrokemiterlimitme="10" d="
            ...
            <g id="stars">
              <g id="starsBig">
                <g>
                  ...
                  <line fill="none" stroke="#0E0620" strokeWidth="3" strokeLinecap="round" nastrokemiterlimitme="10"
              ...
              <g id="circlesBig">
                ...
                <circle fill="none" stroke="#0E0620" strokeWidth="3" strokeLinecap="round" nastrokemiterlimitme="10"
			...
			C360.647,451.083,349.251,457.661,338.164,454.689z" />
              <g id="antenna">
                <line fill="#FFFFFF" stroke="#0E0620" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"
                  nastrokemiterlimitme="10" x1="323.396" y1="236.625" x2="295.285" y2="353.753" />
                <circle fill="#FFFFFF" stroke="#0E0620" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"
                  nastrokemiterlimitme="10" cx="323.666" cy="235.617" r="6.375" />
              </g>
              <g id="armR">
              ...
              <g id="legs">
                <g id="legR">
                  ...
                  <line fill="none" stroke="#0E0620" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"
                    nastrokemiterlimitme="10" x1="304.883" y1="486.849" x2="330.487" y2="493.713" />
                </g>
                <g id="legL">
                  ...
                  <line fill="none" stroke="#0E0620" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"
                    nastrokemiterlimitme="10" x1="262.638" y1="475.522" x2="288.241" y2="482.387" />
                </g>
              </g>
              <g id="head">
                ...
                <ellipse transform="matrix(0.259 -0.9659 0.9659 0.259 -51.5445 563.2371)" fill="#FFFFFF"
                  ...
                  nastrokemiterlimitme="10" cx="341.295" cy="315.211" rx="61.961" ry="60.305" />
                ...
                <g clipPath="url(#GlassClip)">
                  <polygon id="glassShine" fill="none" stroke="#0E0620" strokeWidth="3" nastrokemiterlimitme="10" points="
      ...
      <div className='notFoundContent'>
        ...
        <NavLink exact="true" to='/' className="link color">
          <span>Accueil</span>
        </NavLink>
